...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002465848860'))  # Notification of those who verify will be sent to your channel
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002279696801')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001572271892').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002435587008 -1002279696801').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
